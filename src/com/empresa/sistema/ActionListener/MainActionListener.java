...
public class MainActionListener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if("buttonRegisterAccountClicked".equals(e.getActionCommand())){
            RegisterAccountJInternalFrame registerAccountJInternalFrame = new RegisterAccountJInternalFrame(frame.accountList, frame.user);
            ...
            RegisterProviderJInternalFrame registerProviderJInternalFrame = new RegisterProviderJInternalFrame(frame.providerList, frame.user);
            ...
            RegisterCategoryInternalJFrame registerCategoryInternalJFrame = new RegisterCategoryInternalJFrame(frame.categoriesList, frame.user);
